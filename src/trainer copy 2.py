...
if __name__ == '__main__':  # Required for multiprocessing
    ...
    print(n_env)
    batch_size = (100_000//(n_env))*(n_env) #getting the batch size down to something more manageable - 80k in this case
    print(batch_size)
    steps = batch_size*10 #making sure the experience counts line up properly
    print(steps)
    ...
    env = SB3MultipleInstanceEnv(get_match, num_instances, force_paging=True, wait_time=22) #or 40            # Start instances, waiting 60 seconds between each
